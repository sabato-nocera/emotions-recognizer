...
models_name = "../../models/resnet_nohumidityds_categoricalcrossentropy_adam_normalized_model_"
logs_name = "../../logs/log_resnet_nohumidityds_categoricalcrossentropy_adam_normalized_"
