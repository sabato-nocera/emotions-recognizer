...
now = datetime.now()
output_file_name = "../../logs/log_resnet_fulldb_categoricalcrossentropy_adam_refined_" + str(now)
...
def kfold_cross_validation(X_train_kfold, X_test_kfold, y_train_kfold, y_test_kfold):
    ...
    print("\nK-fold_Fit: epochs=100, batch_size=16, verbose=2, shuffle=False, validation_split=0.2")
    for train, test in kfold.split(inputs, targets):
        ...
        # Fit data to model
        keras_model.fit(X_train2, y_train, epochs=100, batch_size=16, verbose=2, shuffle=False,
...
json_file_name = "../../models/resnet_fulldb_categoricalcrossentropy_adam_refined_model_" + str(now)
...
hdf5_file_name = "../../models/resnet_fulldb_categoricalcrossentropy_adam_refined_model_" + str(now)
