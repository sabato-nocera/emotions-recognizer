...
models_name = "../../models/resnet_nohumidityds_categoricalcrossentropy_adam_greater_normalization_model_"
logs_name = "../../logs/log_resnet_nohumidityds_categoricalcrossentropy_adam_greater_normalization_"
...
dummy_x = utils.greater_normalization(X)
