...
now = datetime.now()
output_file_name = "../../logs/log_resnet_secondreducedb_categoricalcrossentropy_adam_refined_" + str(now)
...
json_file_name = "../../models/resnet_secondreducedb_categoricalcrossentropy_adam_refined_model_" + str(now)
...
hdf5_file_name = "../../models/resnet_secondreducedb_categoricalcrossentropy_adam_refined_model_" + str(now)
