...
models_name = "../../models/resnet_nohumidityds_categoricalcrossentropy_adam_greatest_normalization_model_"
logs_name = "../../logs/log_resnet_nohumidityds_categoricalcrossentropy_adam_greatest_normalization_"
