...
now = datetime.now()
output_file_name = "../../logs/log_lstm_nohumiditydb_categoricalcrossentropy_adam_normalized_bidirectional_" + str(now)
...
def baseline_model():
    ...
    model.add(Bidirectional(LSTM(500, input_shape=(X_train2.shape[1], X_train2.shape[2]))))
...
json_file_name = "../../models/lstm_nohumiditydb_categoricalcrossentropy_adam_normalized_bidirectional_model_" + str(
    now)
...
hdf5_file_name = "../../models/lstm_nohumiditydb_categoricalcrossentropy_adam_normalized_bidirectional_model_" + str(
    now)
