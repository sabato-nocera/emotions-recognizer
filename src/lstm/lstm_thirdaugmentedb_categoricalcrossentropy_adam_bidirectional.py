...
now = datetime.now()
output_file_name = "../../logs/log_lstm_thirdaugmentedb_categoricalcrossentropy_adam_bidirectional_" + str(now)
...
dataset_name = "../../datasets/third_augmented_dataset.csv"
...
history = keras_model.fit(X_train2, y_train, epochs=1455, batch_size=233, verbose=2, shuffle=False,
                          validation_split=0.20, )
...
json_file_name = "../../models/lstm_thirdaugmentedb_categoricalcrossentropy_adam_bidirectional_model_" + str(now)
...
hdf5_file_name = "../../models/lstm_thirdaugmentedb_categoricalcrossentropy_adam_bidirectional_model_" + str(now)
