...
models_name = "../../models/lstm_fullds_categoricalcrossentropy_adam_bidirectional_model_"
logs_name = "../../logs/log_lstm_fullds_categoricalcrossentropy_adam_bidirectional_"
