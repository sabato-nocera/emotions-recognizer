...
models_name = "../../models/lstm_nohumidityds_categoricalcrossentropy_adam_greater_normalization_model_"
logs_name = "../../logs/log_lstm_nohumidityds_categoricalcrossentropy_adam_greater_normalization_"
