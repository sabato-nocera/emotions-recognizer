...
models_name = "../../models/lstm_nohumiditydsreduced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_lstm_nohumiditydsreduced_categoricalcrossentropy_adam_"
