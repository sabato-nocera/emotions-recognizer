...
now = datetime.now()
output_file_name = "../../logs/log_lstm_nohumiditydb_categoricalcrossentropy_adam_bidirectional_" + str(now)
...
json_file_name = "../../models/lstm_nohumiditydb_categoricalcrossentropy_adam_bidirectional_model_" + str(now)
...
hdf5_file_name = "../../models/lstm_nohumiditydb_categoricalcrossentropy_adam_bidirectional_model_" + str(now)
