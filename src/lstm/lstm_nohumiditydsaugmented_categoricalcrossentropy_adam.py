...
models_name = "../../models/lstm_nohumiditydsaugmented_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_lstm_nohumiditydsaugmented_categoricalcrossentropy_adam_"
