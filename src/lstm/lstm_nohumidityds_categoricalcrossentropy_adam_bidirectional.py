...
models_name = "../../models/lstm_nohumidityds_categoricalcrossentropy_adam_bidirectional_model_"
logs_name = "../../logs/log_lstm_nohumidityds_categoricalcrossentropy_adam_bidirectional_"
