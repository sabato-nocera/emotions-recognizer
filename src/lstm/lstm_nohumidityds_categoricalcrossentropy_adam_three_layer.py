...
models_name = "../../models/lstm_nohumidityds_categoricalcrossentropy_adam_three_layer_model_"
logs_name = "../../logs/log_lstm_nohumidityds_categoricalcrossentropy_three_layer_adam_"
...
def baseline_model(print_description=True):
    # create model
    model = Sequential()
    model.add(LSTM(500, return_sequences=True, input_shape=(X_train2.shape[1], X_train2.shape[2])))
    model.add(LSTM(500, return_sequences=True, input_shape=(X_train2.shape[1], X_train2.shape[2])))
