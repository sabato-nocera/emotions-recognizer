...
models_name = "../../models/cnn+lstm_nohumiditydsreduced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_cnn+lstm_nohumiditydsreduced_categoricalcrossentropy_adam_"
