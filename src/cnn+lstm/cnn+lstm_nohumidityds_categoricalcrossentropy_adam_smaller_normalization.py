...
models_name = "../../models/cnn+lstm_nohumidityds_categoricalcrossentropy_adam_smaller_normalization_model_"
logs_name = "../../logs/log_cnn+lstm_nohumidityds_categoricalcrossentropy_adam_smaller_normalization_"
