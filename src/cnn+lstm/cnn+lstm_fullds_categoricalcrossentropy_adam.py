...
import numpy as np
import pandas
from keras.layers import Activation, Embedding, LSTM, MaxPooling1D
...
models_name = "../../models/cnn+lstm_fullds_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_cnn+lstm_fullds_categoricalcrossentropy_adam_"
