...
models_name = "../../models/resnet_nohumiditydsaugmented_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_resnet_nohumiditydsaugmented_categoricalcrossentropy_adam_"
