...
models_name = "../../models/resnet_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_resnet_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_"
...
print("\nNumber of filters:", number_of_filters, ", Kernel Size:", kernel_size_value, ", Strides:", strides_value,
      "Batch Normalization:", batch_normalization_value, ", Conv_First:", conv_first_value, ", Depth Value:",
      depth_value)
