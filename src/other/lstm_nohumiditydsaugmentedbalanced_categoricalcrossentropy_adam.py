...
models_name = "../../models/lstm_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_lstm_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_"
