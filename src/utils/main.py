...
exec(open("../mlp/mlp_secondreducedb_categoricalcrossentropy_adam.py").read())
exec(open("../mlp/mlp_secondreducedb_meansquarederror_adam.py").read())
...
exec(open("../lstm/lstm_secondreducedb_categoricalcrossentropy_adam.py").read())
exec(open("../lstm/lstm_secondreducedb_categoricalcrossentropy_adam_bidirectional.py").read())
...
exec(open("../cnn/cnn_secondreducedb_categoricalcrossentropy_adam_refined.py").read())
exec(open("../cnn/cnn_secondreducedb_categoricalcrossentropy_adam.py").read())
...
exec(open("../resnet/resnet_secondreducedb_categoricalcrossentropy_adam.py").read())
...
exec(open("../decisiontree/decisiontree_secondreducedb.py.py").read())
