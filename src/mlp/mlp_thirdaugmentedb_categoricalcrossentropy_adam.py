...
now = datetime.now()
output_file_name = "../../logs/log_mlp_thirdaugmentedb_categoricalcrossentropy_adam_" + str(now)
...
json_file_name = "../../models/mlp_thirdaugmentedb_categoricalcrossentropy_adam_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_thirdaugmentedb_categoricalcrossentropy_adam_model_" + str(now)
