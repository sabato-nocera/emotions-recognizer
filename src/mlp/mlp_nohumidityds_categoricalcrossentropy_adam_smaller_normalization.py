...
models_name = "../../models/mlp_nohumidityds_categoricalcrossentropy_adam_smaller_normalization_model_"
logs_name = "../../logs/log_mlp_nohumidityds_categoricalcrossentropy_adam_smaller_normalization_"
