...
now = datetime.now()
output_file_name = "../../logs/log_mlp_fulldb_meansquarederror_adam_normalized_" + str(now)
...
json_file_name = "../../models/mlp_fulldb_meansquarederror_adam_normalized_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_fulldb_meansquarederror_adam_normalized_model_" + str(now)
