...
json_file_name = "../../models/mlp_secondaugmentedb_meansquarederror_adam_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_secondaugmentedb_meansquarederror_adam_model_" + str(now)
