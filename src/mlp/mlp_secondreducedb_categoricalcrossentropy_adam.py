...
now = datetime.now()
output_file_name = "../../logs/log_mlp_secondreducedb_categoricalcrossentropy_adam_" + str(now)
...
history = keras_model.fit(X_train, y_train, epochs=220, batch_size=35, verbose=2, shuffle=False,
                          validation_split=0.20)
...
json_file_name = "../../models/mlp_secondreducedb_categoricalcrossentropy_adam_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_secondreducedb_categoricalcrossentropy_adam_model_" + str(now)
