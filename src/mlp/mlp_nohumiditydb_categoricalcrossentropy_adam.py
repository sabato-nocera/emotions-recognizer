...
json_file_name = "../../models/mlp_nohumiditydb_categoricalcrossentropy_adam_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_nohumiditydb_categoricalcrossentropy_adam_model_" + str(now)
