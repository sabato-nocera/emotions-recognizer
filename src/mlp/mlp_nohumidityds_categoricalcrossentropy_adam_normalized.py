...
models_name = "../../models/mlp_nohumidityds_categoricalcrossentropy_adam_normalized_model_"
logs_name = "../../logs/log_mlp_nohumidityds_categoricalcrossentropy_adam_normalized_"
