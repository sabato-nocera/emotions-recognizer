...
now = datetime.now()
output_file_name = "../../logs/log_mlp_fulldb_hinge_adam_normalized_" + str(now)
...
def baseline_model(just_once=0):
    ...
    if just_once == 0:
        ...
        for x in layers:
            print(x.get_config(), "\n")
        print("Compile: loss='hinge', optimizer='adam', metrics=['accuracy']")
...
json_file_name = "../../models/mlp_fulldb_hinge_adam_normalized_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_fulldb_hinge_adam_normalized_model_" + str(now)
