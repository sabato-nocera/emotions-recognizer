...
now = datetime.now()
output_file_name = "../../logs/log_mlp_fulldb_categoricalhinge_adam_" + str(now)
...
json_file_name = "../../models/mlp_fulldb_categoricalhinge_adam_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_fulldb_categoricalhinge_adam_model_" + str(now)
