...
models_name = "../../models/mlp_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_mlp_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_"
