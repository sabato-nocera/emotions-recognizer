...
def baseline_model(just_once=0):
    ...
    if just_once == 0:
        ...
        for x in layers:
            print(x.get_config(), "\n")
        print("Compile: loss='mean_squared_error', optimizer='SFD', metrics=['accuracy']")
...
json_file_name = "../../models/mlp_reducedb_meansquarederror_sgd_model_" + str(now)
...
hdf5_file_name = "../../models/mlp_reducedb_meansquarederror_sgd_model_" + str(now)
