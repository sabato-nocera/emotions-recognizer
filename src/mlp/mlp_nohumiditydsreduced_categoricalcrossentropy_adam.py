...
models_name = "../../models/mlp_nohumiditydsreduced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_mlp_nohumiditydsreduced_categoricalcrossentropy_adam_"
