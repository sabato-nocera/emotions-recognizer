...
models_name = "../../models/mlp_nohumiditydsaugmented_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_mlp_nohumiditydsaugmented_categoricalcrossentropy_adam_"
