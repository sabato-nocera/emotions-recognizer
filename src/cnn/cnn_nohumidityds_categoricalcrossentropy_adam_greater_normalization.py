...
models_name = "../../models/cnn_nohumidityds_categoricalcrossentropy_adam_greater_normalization_model_"
logs_name = "../../logs/log_cnn_nohumidityds_categoricalcrossentropy_adam_greater_normalization_"
