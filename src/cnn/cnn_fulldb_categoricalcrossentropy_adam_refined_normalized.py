...
now = datetime.now()
output_file_name = "../../logs/log_cnn_fulldb_categoricalcrossentropy_adam_refined_normalized_" + str(now)
...
json_file_name = "../../models/cnn_fulldb_categoricalcrossentropy_adam_refined_normalized_model" + str(now)
...
hdf5_file_name = "../../models/cnn_fulldb_categoricalcrossentropy_adam_refined_normalized_model_" + str(now)
