...
models_name = "../../models/cnn_nohumiditydsaugmented_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_cnn_nohumiditydsaugmented_categoricalcrossentropy_adam_"
