...
models_name = "../../models/cnn_nohumidityds_categoricalcrossentropy_adam_normalized_model_"
logs_name = "../../logs/log_cnn_nohumidityds_categoricalcrossentropy_adam_normalized_"
