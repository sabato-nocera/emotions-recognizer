...
models_name = "../../models/cnn_nohumiditydsreduced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_cnn_nohumiditydsreduced_categoricalcrossentropy_adam_"
