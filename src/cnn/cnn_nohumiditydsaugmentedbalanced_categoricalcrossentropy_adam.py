...
models_name = "../../models/cnn_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_model_"
logs_name = "../../logs/log_cnn_nohumiditydsaugmentedbalanced_categoricalcrossentropy_adam_"
